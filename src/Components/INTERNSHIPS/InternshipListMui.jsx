...
export default function InternshipListMui()
{
    let [InternshipData,updateData] = useState(Data);
    let [adProducts, updateProducts] = useState(adProduct);

    console.log('internsipdata',InternshipData);
    console.log('adproduct',adProducts)
    return(
...
<Grid container size={12}  rowSpacing={1} sx={{marginBottom:'8%', padding:'10px',height:'auto'}} >
        ...
        <Grid container spacing={1} >
            ...
            <Typography variant="h7" sx={{fontWeight:500,fontFamily:'Josefin Sans'}}>{element['companyName'] + ' - ' + element['location'] }</Typography>
                ...
                <Grid size={6}  sx={{justifyContent: "center",alignItems: "flex-center",}}>
               <Typography variant="h8" sx={{fontWeight:350,fontFamily:'Josefin Sans'}}> {element['positionType']}</Typography>
                ...
                <Grid size={6}>
               <Typography variant="h7" sx={{fontWeight:350,fontFamily:'Josefin Sans'}}>{element['salary']}</Typography>
                </Grid>
                <Grid size={6}>
        ...
        <Grid container size={12}sx={{ minHeight:'100px', backgroundColor:'#c5cae9'}} >
            ...
            {/* <Typography variant="h8">View Details  &#8594;</Typography> */}
             <NavLink to={`/InternshipDetailsPage/${element['id']}`}><Button size="large" sx={{color:'#283593',fontWeight:'bolder'}}>View Details  &#8594;</Button></NavLink> 
            </Grid>
        </Grid>
