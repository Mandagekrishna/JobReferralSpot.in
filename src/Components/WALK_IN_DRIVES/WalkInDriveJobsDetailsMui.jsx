...
<Grid container size={{md:9}} sx={{marginRight:'50px'}}  >
    ...
    <Stack>
    <Typography variant='h6'>Apply at - <a href={currentJobs[0]['applyLink']}>click here</a> </Typography>
    <Typography variant='h6'> Interview Location</Typography>
    <Typography variant='body1'>{currentJobs[0]['address']}</Typography>
    <Typography variant='h6'> Timing</Typography>
    <Typography variant='body1'>{currentJobs[0]['timing']} </Typography> 
